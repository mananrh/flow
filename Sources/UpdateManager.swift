...
final class UpdateManager: ObservableObject {
    ...
    private let releasesURL = URL(string: "https://api.github.com/repos/mananrathod/flow/releases?per_page=100")!
    ...
    func checkForUpdates(userInitiated: Bool) async {
        let currentBuildTag = Bundle.main.infoDictionary?["FlowBuildTag"] as? String
    ...
    private func performUpdate(downloadURL: URL, expectedSize: Int) async {
        ...
        let tempDir = fm.temporaryDirectory.appendingPathComponent("flow-update-\(UUID().uuidString)")
        ...
        let dmgPath = tempDir.appendingPathComponent("Flow.dmg")
        ...
        do {
            ...
            let stagingDir = fm.temporaryDirectory.appendingPathComponent("flow-staged-\(UUID().uuidString)")
