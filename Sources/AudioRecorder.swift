...
final class AudioRecorder: NSObject, ObservableObject, AVCaptureAudioDataOutputSampleBufferDelegate {
    ...
    private let sessionQueue = DispatchQueue(label: "com.mananrathod.flow.capture.session")
    private let sampleBufferQueue = DispatchQueue(label: "com.mananrathod.flow.capture.samples")
